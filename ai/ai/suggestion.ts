...
/**
 * Temporary mock until real AI logic is connected.
 */
 ...
 * Later, replace this with ranking + recovery logic.
 */
export function generateSuggestion(
  ctx: SuggestionCtx
): { plan: Plan; isUncertainDay: boolean } {
